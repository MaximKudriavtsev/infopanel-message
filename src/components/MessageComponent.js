    ...
    return (
        <div className="eventPage">
            <div className="eventPage_orange">
                ...
                <div className="eventPage_orange_circle" style={{height: 25*vh,
                                                                width: 25*vh,
                                                                border: vh + 'px solid white'}}>
                    <div className="img" style={{ backgroundImage: `url('${imageUrl}')` }} />
                </div>
                <div className="eventPage_orange_text" style={{ fontSize: +14*vh + 'px',
                                                                paddingTop: 0,
                                                                paddingRight: 6*vh,
                                                                paddingBottom: 0,
                                                                paddingLeft: 6*vh }}>
            ...
            <div className="eventPage_white" style={{ paddingTop: 3*vh,
                                                     paddingRight: 5*vh,
                                                     paddingBottom: 0,
                                                     paddingLeft: 5*vh}}>
                <div className="eventPage_white_date" style={{ fontSize: + 16*vh + 'px',
                                                            marginRight: 0.5*vh }}>
                    {eventDate.getDate()}
                </div>
                <div className="eventPage_white_textBlock_left" style={{ fontSize: 7*vh,
                                                                        marginTop: 1.5*vh,
                                                                        marginRight: 0,
                                                                        marginBottom: 1*vh,
                                                                        marginLeft: 0 }}>
                ...
                <div className="eventPage_white_textBlock_right" style={{ fontSize: 7*vh,
                                                                        marginTop: 1.5*vh,
                                                                        marginRight: 0,
                                                                        marginBottom: 1*vh,
                                                                        marginLeft: 0 }}>
